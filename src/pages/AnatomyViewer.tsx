                ...
                <CardHeader>
                  <div className="flex items-center gap-3 mb-2">
                    <div
                      ...
                      style={{ backgroundColor: organs[selectedOrgan as keyof typeof organs].color }}
                    />
                  ...
                  <CardDescription className="text-base">
                    {organs[selectedOrgan as keyof typeof organs].description}
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      {organs[selectedOrgan as keyof typeof organs].function}
                    </p>
                  </div>
