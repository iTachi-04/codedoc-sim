...
const Profile = () => {
  ...
  const userData = {
    name: "Dr. Student",
    email: "student@codemed.ai",
    joinDate: "January 2024",
    casesCompleted: 4,
    totalCases: 10,
    averageScore: 82,
    achievements: [
      { name: "First Diagnosis", icon: Award, earned: true },
      { name: "Perfect Score", icon: TrendingUp, earned: false },
      { name: "Case Master", icon: BookOpen, earned: false },
    ],
  };

  const recentCases = [
    { name: "Chest Pain Emergency", score: 85, date: "2 days ago" },
    { name: "Persistent Fever", score: 78, date: "5 days ago" },
    { name: "Abdominal Pain", score: 90, date: "1 week ago" },
    { name: "Chest Pain Emergency", score: 75, date: "2 weeks ago" },
  ];
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm text-muted-foreground">
                      {userData.casesCompleted} / {userData.totalCases}
                    </span>
                  </div>
                  <Progress value={(userData.casesCompleted / userData.totalCases) * 100} />
                </div>

                <div className="grid grid-cols-3 gap-4">
                  <div className="bg-muted p-4 rounded-lg text-center">
                    <p className="text-3xl font-bold text-primary">{userData.casesCompleted}</p>
                    <p className="text-sm text-muted-foreground mt-1">Cases Done</p>
                  </div>
                  <div className="bg-muted p-4 rounded-lg text-center">
                    <p className="text-3xl font-bold text-accent">{userData.averageScore}%</p>
